...
class ElasticquentService
{
    ...
    public function where(array $array): object
    {
        ...
        if (is_numeric(array_key_first($match[0]['match']))) {
            throw new LogicException('array should be an associative array', Response::HTTP_UNPROCESSABLE_ENTITY);
        }
